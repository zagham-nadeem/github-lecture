...
$propertyRef = filter_var($obj["property_ref"], FILTER_SANITIZE_STRING);
$propertyUrl = filter_var($obj["property_url"], FILTER_SANITIZE_STRING);
...
if ($propertyRef && $propertyUrl && $contactName && $contactPhone && $contactEmail && $contactMessage){
