...
<script type="text/javascript">
  $(document).ready(function(){
    $('#table_id').dataTable({
     "bProcessing": true,
     "sAjaxSource": "../controller/get_zones_data.php",
     "responsive": true,
     "bPaginate":true,
     "aaSorting": [[1,'desc']],
     ...
     "iDisplayLength": 10,
     "aoColumns": [
     { mData: 'pt_zone_id', "width": "5%", "className": "text-center" },
    { mData: 'tr_name'},
    { mData: 'city_name'},
    { "mData": null ,
    "width": "14%",
    ...
    "mRender" : function (data) {
      return "<a data-toggle='modal' data-target='#view-modal' id='showEditModal' class='btn btn-small btn-primary' style='color:#fff' data-id='"+data.pt_zone_id+"'>"+EDITITEM+"</a> <a class='btn btn-small btn-danger btn-delete deleteItem' data-url='../controller/delete_zone.php?id="+data.pt_zone_id+"'>"+DELETEITEM+"</a>";}
    }
    ]
  });
  });
    ...
    <div class="content sm-gutter">
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="section-title">
          <h5 class="text-truncate"><?php echo _ZONES; ?></h5>
        </div>
                  ...
                  <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%" style="border-radius: 5px;">
                    <thead>
                      <tr>
                        ...
                        <th><?php echo _TABLEFIELDCITY; ?></th>
                        <th></th>
                      </tr>
                    </thead>
                  </table>
...
<div id="add_data_Modal" class="modal fade">
 <div class="modal-dialog">
  ...
  <div class="modal-body">
    <form enctype="multipart/form-data" method="post" id="insertZone">
     ...
     <select class="custom-select form-control" name="pt_zone_city" required="">
...
$(document).ready(function(){
  $(document).on('click', '#showEditModal', function(e){
      ...
      $('#modal-loader').show();
      $.ajax({
          url: '../controller/get_zones_languages.php',
          type: 'POST',
          data: 'id='+uid,
          dataType: 'html'
      })
