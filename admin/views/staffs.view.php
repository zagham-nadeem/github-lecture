...
<script type="text/javascript">
  $(document).ready(function(){
    $('#table_id').dataTable({
     "bProcessing": true,
     "sAjaxSource": "../controller/get_staffs.php",
     "responsive": true,
     "bPaginate":true,
     "aaSorting": [[1,'desc']],
     ...
     "iDisplayLength": 10,
     "aoColumns": [
     { mData: 'staff_id', "width": "5%", "className": "text-center" },
     { "mData": null , "width": "12%", "className": "product text-center",
     "mRender" : function (data) {

        if(data.staff_image){
          return "<img src='../../images/"+data.staff_image+"' class='product-img product-img-p'/>";
        }else{
            return "<img src='../assets/images/avatar.png' class='product-img product-img-p'/>";
        }
    ...
    'searchable': false,
    "mRender" : function (data) {
      return "<a data-toggle='modal' data-target='#view-modal' id='showEditModal' class='btn btn-small btn-primary' style='color:#fff' data-id='"+data.staff_id+"'>"+EDITITEM+"</a> <a class='btn btn-small btn-danger btn-delete deleteItem' data-url='../controller/delete_staff.php?id="+data.staff_id+"'>"+DELETEITEM+"</a>";}
    }
    ]
  });
  });
    ...
    <div class="content sm-gutter">
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="section-title">
          <h5 class="text-truncate"><?php echo _STAFF; ?></h5>
        </div>

        <div class="row">

          <div class="col-12 c-col-12">
            <a class="btn btn-primary" href="../controller/new_staff.php">
...
$(document).ready(function(){
  $(document).on('click', '#showEditModal', function(e){
      ...
      $('#modal-loader').show();
      $.ajax({
          url: '../controller/get_staffs_languages.php',
          type: 'POST',
          data: 'id='+uid,
          dataType: 'html'
      })
